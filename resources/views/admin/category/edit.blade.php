                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" id="category_ex_title"
                                                ...
                                                value="{{ old('category_ex_title', $category->category_ex_title) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" id="category_ex_link"
                                                ...
                                                value="{{ old('category_ex_link' , $category->category_ex_link) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" id="category_videolink"
                                                ...
                                                value="{{ old('category_videolink', $category->category_videolink) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="category_desc" id="category_desc" cols="30" rows="3"
                                                placeholder="Enter...">{{ old('category_desc', $category->category_desc) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="category_list_desc" id="category_list_desc" cols="30" rows="3"
                                                placeholder="Enter...">{{ old('category_list_desc', $category->category_list_desc) }}</textarea>
                                        </div>
                                    </div>

                                    @php
                                     $featureIds = $category->features->pluck('id')->toArray();                                     
                                    @endphp
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="schema_markup" id="schema_markup" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('schema_markup', $category->schema_markup) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="focus_keyword" id="focus_keyword" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('focus_keyword', $category->focus_keyword) }}</textarea>
                                        </div>
                                    </div>
