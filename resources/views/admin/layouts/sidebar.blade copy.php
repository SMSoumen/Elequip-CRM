<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column custom_admin_sidebar" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">                        
                        ...
                        @can('Category create')
                        <li class="nav-item">
                            <a href="{{route('admin.categories.create')}}" class="nav-link @if(Request::is('admin/categories/create')) active @endif">
                                <i class="nav-icon fas fa-sitemap"></i>
                                <p>
                                  Add Category
                                </p>
                        ...
                        @can('Category access')
                        <li class="nav-item">
                            <a href="{{route('admin.category.treeview')}}" class="nav-link @if(Request::is('admin/categories-treeview')) active @endif">
                                <i class="nav-icon fas fa-sitemap"></i>
                                <p>
                                    Category Treeview
                                </p>
                        ...
                        @can('Unit access')
                        {{-- <li class="nav-item">
                            <a href="{{route('admin.units.index')}}" class="nav-link @if(Request::is('admin/units*')) active @endif">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Unit
                                </p>
                        ...
                        @can('Tax access')
                        <li class="nav-item">
                            <a href="{{route('admin.taxes.index')}}" class="nav-link @if(Request::is('admin/taxes*')) active @endif">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                Tax
                                </p>
                        ...
                        @can('Product access')
                        <li class="nav-item">
                            <a href="{{route('admin.products.index')}}" class="nav-link @if(Request::is('admin/products*')) active @endif">
                                <i class="nav-icon fas fa-cubes"></i>
                                <p>
                                Product
                                </p>
                        ...
                        @can('ProductAttribute access')
                        <li class="nav-item">
                            <a href="{{route('admin.attributes.index')}}" class="nav-link @if(Request::is('admin/attributes*')) active @endif">
                                <i class="nav-icon fas fa-cubes"></i>
                                <p>
                                Product Attribute
                                </p>
