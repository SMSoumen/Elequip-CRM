                ...
                <tbody>
                    ...
                    @foreach ($letest_quotation_details as $key => $quotation)
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="rate[]" class="rate"
                                    value="{{ $quotation->quot_product_unit_price }}"></td>
                            <td><input type="text" name="amount[]" class="amount" value="{{ $amount }}"
                                    readonly></td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group">
                                ...
                                <input type="text" id="basic_amount" aria-label="Username"
                                    aria-describedby="basic-addon1" value="Rs. {{ $total_amount }}" readonly>
                            </div>
                        </td>
                    </tr>
                </tbody>
