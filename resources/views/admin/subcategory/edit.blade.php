                        ...
                        <div class="col-lg-12 col-12">
                            ...
                            <form action="{{ route('admin.subcategories.update', $subcategory->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    @php
                                     $scatTypes = $subcategory->types->pluck('id')->toArray();                                     
                                    @endphp
                                            ...
                                            <div class="select2-purple">
                                                <select class="select2" multiple="multiple"
                                                    ...
                                                    @forelse($types as $type)
                                                        <option value="{{ $type->id }}" @if (in_array($type->id, $scatTypes)) selected @endif>{{ $type->product_type }}
                                                        </option>
                                                    @empty
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="color" required class="form-control" id="bg_color"
                                                ...
                                                value="{{ old('bg_color' , $subcategory->bg_color) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" id="subcategory_ex_title"
                                                ...
                                                value="{{ old('subcategory_ex_title', $subcategory->subcategory_ex_title) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" id="subcategory_ex_link"
                                                ...
                                                value="{{ old('subcategory_ex_link', $subcategory->subcategory_ex_link) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="subcategory_desc" id="subcategory_desc" cols="30" rows="3"
                                                placeholder="Enter...">{{ old('subcategory_desc', $subcategory->subcategory_desc) }}</textarea>
                                        </div>
                                    </div>

                                    @php
                                     $featureIds = $subcategory->features->pluck('id')->toArray();                                     
                                    @endphp
                                            ...
                                            <div class="select2-purple">
                                                <select class="select2" multiple="multiple"
                                                    ...
                                                    @forelse($features as $feature)
                                                        <option value="{{ $feature->id }}" @if (in_array($feature->id, $featureIds)) selected @endif >{{ $feature->feature_title }} ({{ $feature->feature_tag }})
                                                        </option>
                                                    @empty
                                                        <option value="">No Feature found</option>
                                                    @endforelse
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="meta_description" id="meta_description" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('meta_description', $subcategory->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="meta_keywords" id="meta_keywords" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('meta_keywords', $subcategory->meta_keywords) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="schema_markup" id="schema_markup" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('schema_markup', $subcategory->schema_markup) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="focus_keyword" id="focus_keyword" cols="30"
                                                rows="3" placeholder="Enter...">{{ old('focus_keyword', $subcategory->focus_keyword) }}</textarea>
                                        </div>
                                    </div>
